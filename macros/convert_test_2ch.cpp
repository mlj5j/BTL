...
*/
  ...
  TBranch *ch_b = pulse->Branch("chmV", &chmV, "chmV[2][1024]/D"); 
  TBranch *time_b = pulse->Branch("time", &time, "time[2][1024]/F");  
  TBranch *event_b = pulse->Branch("event", &event, "event/I");
  TBranch *RMS_b = pulse->Branch("RMS", &RMS, "RMS[2]/D");
  TBranch *amp_b = pulse->Branch("amp", &amp, "amp[2]/D");
  TBranch *mean_b = pulse->Branch("mean", &mean, "mean[2]/D");
  TBranch *integral_b = pulse->Branch("integral", &integral, "integral[2]/D");
